...
const (
	...
	User_CheckPasswordInfo_FullMethodName = "/User/CheckPasswordInfo"
)
...
func (c *userClient) CheckPasswordInfo(ctx context.Context, in *PasswordCheck, opts ...grpc.CallOption) (*CheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, User_CheckPasswordInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) CheckPasswordInfo(context.Context, *PasswordCheck) (*CheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckPasswordInfo not implemented")
}
...
func _User_CheckPasswordInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PasswordCheck)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).CheckPasswordInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_CheckPasswordInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CheckPasswordInfo(ctx, req.(*PasswordCheck))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckPasswordInfo",
			Handler:    _User_CheckPasswordInfo_Handler,
		},
	},
